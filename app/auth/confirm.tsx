            ...
            <SafeAreaView className="flex-1 px-6 py-10">
                ...
                >
                    ...
                    <Text className="mt-2 text-base text-blue-100">
                        We sent a code to <Text className="font-bold text-white">{email}</Text>
                    </Text>
                </Animated.View>
                ...
                <View>
                    ...
                    >
                        <TouchableOpacity
                            ...
                            disabled={loading}
                            className={`mt-2 flex-row items-center justify-center rounded-2xl py-4 shadow-lg ${loading ? "bg-blue-400" : "bg-white"
                                }`}
                        >
                            {loading ? (
                    ...
                    >
                        <TouchableOpacity
                            onPress={async () => {
                                ...
                                Alert.alert("Sending...", "Please wait.");
                                const { error } = await resendOtp(email);
                                if (error) {
                                    Alert.alert("Error", error.message);
                                } else {
                                    Alert.alert("Sent!", "Check your email for a new code.");
                                }
                            }}
