...
export const PaymentModal = ({ isVisible, onClose, item }: PaymentModalProps) => {
    ...
    const handleBuy = async () => {
        ...
        try {
            ...
            Alert.alert("Success", "Payment successful! Order created.");
            onClose();
            ...
            <View className="flex-1 justify-end bg-black/50">
                <View className="bg-white dark:bg-gray-900 rounded-t-3xl p-6 h-[40%]">
                    <View className="flex-row justify-between items-center mb-6">
                        <Text className="text-gray-900 dark:text-white text-xl font-bold">Checkout</Text>
                    ...
                    <View className="mb-6">
                        <Text className="text-gray-500 dark:text-gray-400 text-sm uppercase">Item</Text>
                        <Text className="text-gray-900 dark:text-white text-lg font-medium">{item.title}</Text>
                        <Text className="text-gray-900 dark:text-white text-2xl font-bold mt-2">${item.price}</Text>
                    </View>

                    <View className="flex-row items-center justify-between mb-8">
                        <Text className="text-gray-500 dark:text-gray-400">Total (Fees included)</Text>
